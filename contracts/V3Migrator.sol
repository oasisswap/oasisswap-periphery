...
import '@OasisSwap/v2-core/contracts/interfaces/IOasisSwapV2Pair.sol';
...
contract V3Migrator is IV3Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IOasisSwapV2Pair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = IOasisSwapV2Pair(params.pair).burn(address(this));
