...
import '@OasisSwap/v3-core/contracts/libraries/TickMath.sol';
import '@OasisSwap/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IOasisSwapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IOasisSwapV3Pool) {
        return IOasisSwapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IOasisSwapV3SwapCallback
    function OasisSwapV3SwapCallback(
        ...
        IOasisSwapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IOasisSwapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
