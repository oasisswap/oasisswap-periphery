...
import { IOasisSwapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
import { abi as IOasisSwapV3PoolABI } from '@OasisSwap/v3-core/artifacts/contracts/interfaces/IOasisSwapV3Pool.sol/IOasisSwapV3Pool.json'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IOasisSwapV3Pool, IOasisSwapV3Pool, IOasisSwapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IOasisSwapV3PoolABI, wallet)) as [
      IOasisSwapV3Pool,
      IOasisSwapV3Pool,
      IOasisSwapV3Pool
    ]
  ...
  let pools: [IOasisSwapV3Pool, IOasisSwapV3Pool, IOasisSwapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestOasisSwapV3Callee')
