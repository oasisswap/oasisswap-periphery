...
import { abi as PAIR_V2_ABI } from '@OasisSwap/v2-core/build/OasisSwapV2Pair.json'
...
describe('V3Migrator', () => {
  ...
  let factoryV3: IOasisSwapV3Factory
  let token: TestERC20
  let weth9: IWETH9
  let nft: MockTimeNonfungiblePositionManager
  let migrator: V3Migrator
  let pair: IOasisSwapV2Pair
  ...
  describe('#migrate', () => {
    ...
    beforeEach('add V2 liquidity', async () => {
      ...
      pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IOasisSwapV2Pair
